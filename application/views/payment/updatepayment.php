                                    ...
                                    <div class="card-content">
                                        <div class="row">
                                            ...
                                            <div class="form-group label-floating togglebutton">
                                                <label>
                                                    <input type="checkbox" name="stripe" <?php if($config->status == 'on'){ echo "checked"; } ?>>
                                                </label>
                                            </div>
                                        </div>
                                        <div class="row">
                                            ...
                                            <div class="col-sm-10">
                                                <div class="form-group label-floating is-empty">
                                                    ...
                                                    <input type="text" class="form-control" value="<?php echo $config->secret_key; ?>" name="payment_sek_key">
                                                </div>
                                            </div>
                                        </div>
                                        <div class="row">
                                            ...
                                            <div class="col-sm-10">
                                                <div class="form-group label-floating is-empty">
                                                    <label class="control-label"></label>
                                                    <input type="text" class="form-control" value="<?php echo $config->pub_key; ?>" name="payment_private_key">
                                                </div>
                                            </div>
                                        </div>
                                        <div class="row">
                                            ...
                                            <div class="col-sm-10">
                                                <div class="form-group label-floating is-empty">
                                                    <label class="control-label"></label>
                                                    <input type="text" class="form-control" value="<?php echo $config->mode; ?>" name="mode">
                                                </div>
                                            </div>
                                        </div>
