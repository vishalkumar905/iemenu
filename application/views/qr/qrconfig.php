									   ...
									   <form action="<?php echo base_url('QrController/qrConfigSave'); ?>" method="post" enctype="multipart/form-data">
										...
										<h4>QR Settings</h4>
												...
												<div class="col-md-6">
													<div class="togglebutton">
														<label>
															<input type="checkbox" name="display_logo"> 
														</label>
													</div>
												</div>
												<div class="col-md-6">
												...
												<div class="col-md-6">
													<div class="togglebutton">
														<label>
															<input type="checkbox" name="display_table"> 
														</label>
													</div>
												</div>
												<div class="col-md-6">
												...
												<div class="col-md-6">
													<div class="togglebutton">
														<label>
															<input type="checkbox" name="display_venue"> 
														</label>
													</div>
												</div>
											</div>
										...
										<h4>QR Design</h4>
												<div class="row">
													...
													<div class="col-md-6">
														<div class="togglebutton">
															<label>
																<input type="checkbox" name="display_bg"> 
															</label>
														</div>
													</div>
												</div>
										...
										<div class="row">
											<div class="col-md-6">
												...
												<input type="text" name="wlcm" class="form-control">
											...
											<div class="col-md-6">
												...
												<input type="text" name="custom_msg" class="form-control">
												<span class="material-input"></span>
												</div>
											</div>
                                        </div>
